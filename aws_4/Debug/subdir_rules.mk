...
build-1085872721:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1085872721-inproc

build-1085872721-inproc: ../aws_iot.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1085872721 ../aws_iot.cfg
configPkg/compiler.opt: build-1085872721
configPkg/: build-1085872721
