...
linker.cmd: package/cfg/uartlogging_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/uartlogging_pem4fcfg.cmd\)\"$""\"C:/Users/mfathy/workspace_v9_2/uartlogging_EK_TM4C1294XL_TI/.config/xconfig_uartlogging/\1\""' package/cfg/uartlogging_pem4f.xdl > $@
