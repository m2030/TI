...
build-894450769:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-894450769-inproc

build-894450769-inproc: ../uartlogging.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-894450769 ../uartlogging.cfg
configPkg/compiler.opt: build-894450769
configPkg/: build-894450769
