...
linker.cmd: package/cfg/httpsget_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/httpsget_pem4fcfg.cmd\)\"$""\"C:/Users/mfathy/workspace_v9_2/httpsget_EK_TM4C1294XL_TI/.config/xconfig_httpsget/\1\""' package/cfg/httpsget_pem4f.xdl > $@
