...
linker.cmd: package/cfg/uartecho_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/uartecho_pem4fcfg.cmd\)\"$""\"C:/Users/mfathy/workspace_v9_2/uartecho_EK_TM4C1294XL_TI/.config/xconfig_uartecho/\1\""' package/cfg/uartecho_pem4f.xdl > $@
