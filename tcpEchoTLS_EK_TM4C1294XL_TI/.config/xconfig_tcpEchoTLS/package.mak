...
override PKGDIR = xconfig_tcpEchoTLS
...
package/%.xdc.inc package/%_xconfig_tcpEchoTLS.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_tcpEchoTLS" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: tcpEchoTLS.pem4f

-include package/cfg/tcpEchoTLS_pem4f.mak
-include package/cfg/tcpEchoTLS_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/tcpEchoTLS_pem4f.dep
endif
tcpEchoTLS.pem4f: package/cfg/tcpEchoTLS_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
tcpEchoTLS.pem4f package/cfg/tcpEchoTLS_pem4f.c: .libraries,em4f
endif

package/cfg/tcpEchoTLS_pem4f.c package/cfg/tcpEchoTLS_pem4f.h package/cfg/tcpEchoTLS_pem4f.xdl: override _PROG_NAME := tcpEchoTLS.xem4f
package/cfg/tcpEchoTLS_pem4f.c: package/cfg/tcpEchoTLS_pem4f.cfg
package/cfg/tcpEchoTLS_pem4f.xdc.inc: package/cfg/tcpEchoTLS_pem4f.xdl
package/cfg/tcpEchoTLS_pem4f.xdl package/cfg/tcpEchoTLS_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/tcpEchoTLS_pem4f.cfg
	-$(RM) package/cfg/tcpEchoTLS_pem4f.dep
	-$(RM) package/cfg/tcpEchoTLS_pem4f.c
	-$(RM) package/cfg/tcpEchoTLS_pem4f.xdc.inc

clean,em4f::
	-$(RM) tcpEchoTLS.pem4f
.executables,em4f .executables: tcpEchoTLS.xem4f

tcpEchoTLS.xem4f: |tcpEchoTLS.pem4f

-include package/cfg/tcpEchoTLS.xem4f.mak
tcpEchoTLS.xem4f: package/cfg/tcpEchoTLS_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00  -q -o $@ package/cfg/tcpEchoTLS_pem4f.oem4f   package/cfg/tcpEchoTLS_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
tcpEchoTLS.xem4f: export C_DIR=
tcpEchoTLS.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
tcpEchoTLS.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

tcpEchoTLS.test test,em4f test: tcpEchoTLS.xem4f.test

tcpEchoTLS.xem4f.test:: tcpEchoTLS.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 tcpEchoTLS.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.tcpEchoTLS.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,tcpEchoTLS.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
tcpEchoTLS_pem4f.oem4f,copy : package/cfg/tcpEchoTLS_pem4f.oem4f
tcpEchoTLS_pem4f.sem4f,copy : package/cfg/tcpEchoTLS_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_tcpEchoTLS
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_tcpEchoTLS.tar.dep
endif
package/rel/xconfig_tcpEchoTLS/xconfig_tcpEchoTLS/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_tcpEchoTLS/xconfig_tcpEchoTLS/package/package.rel.xml: package/build.cfg
package/rel/xconfig_tcpEchoTLS/xconfig_tcpEchoTLS/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_tcpEchoTLS/xconfig_tcpEchoTLS/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_tcpEchoTLS.tar: package/rel/xconfig_tcpEchoTLS.xdc.inc package/rel/xconfig_tcpEchoTLS/xconfig_tcpEchoTLS/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_tcpEchoTLS.xdc.inc,package/rel/xconfig_tcpEchoTLS.tar.dep)


release release,xconfig_tcpEchoTLS: all xconfig_tcpEchoTLS.tar
clean:: .clean
	-$(RM) xconfig_tcpEchoTLS.tar
	-$(RM) package/rel/xconfig_tcpEchoTLS.xdc.inc
	-$(RM) package/rel/xconfig_tcpEchoTLS.tar.dep
