...
The example then makes an HTTP GET call to "www.timeapi.org" to fetch the
current date-time for the timezone defined and print it to the console.
...
httpTask  Creates a connection to the HTTP server. When a connection is
          ...
          processed to extract the date-time information. The connection is
